...
// Controllo di sicurezza: solo gli admin possono eliminare!
if (!isset($_SESSION['user_cf']) || $_SESSION['ruolo'] != 'admin') { 
...
// VULNERABILE
$sql = "DELETE FROM documenti_segreti WHERE id = $id";
$conn->multi_query($sql);

// Torna alla lista con un messaggio di successo
header("Location: documenti_segreti.php?msg=Documento+Distrutto");
exit();
?>